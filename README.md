...
Be is pre-1.0, but it's ready for production (or maybe I should say "testing"). I've used it in different projects — a CLI tool, an API server, and a database engine — and it worked great every time.
